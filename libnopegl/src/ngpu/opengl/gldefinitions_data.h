...
static const struct gldefinition {
    ...
    {"glBindImageTexture", offsetof(struct glfunctions, BindImageTexture), M},
    ...
    {"glDispatchCompute", offsetof(struct glfunctions, DispatchCompute), M},
    ...
    {"glGetInternalformativ", offsetof(struct glfunctions, GetInternalformativ), M},
    {"glGetProgramInfoLog", offsetof(struct glfunctions, GetProgramInfoLog), M},
    {"glGetProgramInterfaceiv", offsetof(struct glfunctions, GetProgramInterfaceiv), M},
    {"glGetProgramResourceIndex", offsetof(struct glfunctions, GetProgramResourceIndex), M},
    {"glGetProgramResourceLocation", offsetof(struct glfunctions, GetProgramResourceLocation), M},
    {"glGetProgramResourceName", offsetof(struct glfunctions, GetProgramResourceName), M},
    {"glGetProgramResourceiv", offsetof(struct glfunctions, GetProgramResourceiv), M},
    ...
    {"glMemoryBarrier", offsetof(struct glfunctions, MemoryBarrier), M},
    ...
    {"glTexStorage2D", offsetof(struct glfunctions, TexStorage2D), M},
    {"glTexStorage3D", offsetof(struct glfunctions, TexStorage3D), M},
