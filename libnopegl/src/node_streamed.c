...
DECLARE_STREAMED_INIT(int,    s->ivector, sizeof(*s->ivector),     NGLI_TYPE_I32)
...
DECLARE_STREAMED_INIT(uint,   s->uvector, sizeof(*s->uvector),     NGLI_TYPE_U32)
DECLARE_STREAMED_INIT(uivec2, s->uvector, 2 * sizeof(*s->uvector), NGLI_TYPE_UVEC2)
DECLARE_STREAMED_INIT(uivec3, s->uvector, 3 * sizeof(*s->uvector), NGLI_TYPE_UVEC3)
DECLARE_STREAMED_INIT(uivec4, s->uvector, 4 * sizeof(*s->uvector), NGLI_TYPE_UVEC4)
DECLARE_STREAMED_INIT(float,  s->vector,  sizeof(*s->vector),      NGLI_TYPE_F32)
