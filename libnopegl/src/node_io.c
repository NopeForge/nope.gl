...
DEFINE_IO_CLASS(NGL_NODE_IOINT,    "IOInt",    int,    NGLI_TYPE_I32)
...
DEFINE_IO_CLASS(NGL_NODE_IOUINT,   "IOUInt",   uint,   NGLI_TYPE_U32)
DEFINE_IO_CLASS(NGL_NODE_IOUIVEC2, "IOUIvec2", uivec2, NGLI_TYPE_UVEC2)
DEFINE_IO_CLASS(NGL_NODE_IOUIVEC3, "IOUIvec3", uivec3, NGLI_TYPE_UVEC3)
DEFINE_IO_CLASS(NGL_NODE_IOUIVEC4, "IOUIvec4", uivec4, NGLI_TYPE_UVEC4)
DEFINE_IO_CLASS(NGL_NODE_IOFLOAT,  "IOFloat",  float,  NGLI_TYPE_F32)
