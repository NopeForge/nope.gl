...
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERINT,    "BufferInt",    int,    NGLI_FORMAT_R32_SINT,            NGLI_TYPE_I32)
...
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUINT,   "BufferUInt",   uint,   NGLI_FORMAT_R32_UINT,            NGLI_TYPE_U32)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC2, "BufferUIVec2", uivec2, NGLI_FORMAT_R32G32_UINT,         NGLI_TYPE_UVEC2)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC3, "BufferUIVec3", uivec3, NGLI_FORMAT_R32G32B32_UINT,      NGLI_TYPE_UVEC3)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC4, "BufferUIVec4", uivec4, NGLI_FORMAT_R32G32B32A32_UINT,   NGLI_TYPE_UVEC4)
...
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERFLOAT,  "BufferFloat",  float,  NGLI_FORMAT_R32_SFLOAT,          NGLI_TYPE_F32)
