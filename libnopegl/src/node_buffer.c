...
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERBYTE, "BufferByte", byte, NGPU_FORMAT_R8_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERBVEC2, "BufferBVec2", bvec2, NGPU_FORMAT_R8G8_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERBVEC3, "BufferBVec3", bvec3, NGPU_FORMAT_R8G8B8_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERBVEC4, "BufferBVec4", bvec4, NGPU_FORMAT_R8G8B8A8_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERINT, "BufferInt", int, NGPU_FORMAT_R32_SINT, NGLI_TYPE_I32)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERINT64, "BufferInt64", int64, NGPU_FORMAT_R64_SINT, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERIVEC2, "BufferIVec2", ivec2, NGPU_FORMAT_R32G32_SINT, NGLI_TYPE_IVEC2)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERIVEC3, "BufferIVec3", ivec3, NGPU_FORMAT_R32G32B32_SINT, NGLI_TYPE_IVEC3)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERIVEC4, "BufferIVec4", ivec4, NGPU_FORMAT_R32G32B32A32_SINT, NGLI_TYPE_IVEC4)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERSHORT, "BufferShort", short, NGPU_FORMAT_R16_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERSVEC2, "BufferSVec2", svec2, NGPU_FORMAT_R16G16_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERSVEC3, "BufferSVec3", svec3, NGPU_FORMAT_R16G16B16_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERSVEC4, "BufferSVec4", svec4, NGPU_FORMAT_R16G16B16A16_SNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUBYTE, "BufferUByte", ubyte, NGPU_FORMAT_R8_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUBVEC2, "BufferUBVec2", ubvec2, NGPU_FORMAT_R8G8_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUBVEC3, "BufferUBVec3", ubvec3, NGPU_FORMAT_R8G8B8_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUBVEC4, "BufferUBVec4", ubvec4, NGPU_FORMAT_R8G8B8A8_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUINT, "BufferUInt", uint, NGPU_FORMAT_R32_UINT, NGLI_TYPE_U32)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC2, "BufferUIVec2", uivec2, NGPU_FORMAT_R32G32_UINT, NGLI_TYPE_UVEC2)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC3, "BufferUIVec3", uivec3, NGPU_FORMAT_R32G32B32_UINT, NGLI_TYPE_UVEC3)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUIVEC4, "BufferUIVec4", uivec4, NGPU_FORMAT_R32G32B32A32_UINT, NGLI_TYPE_UVEC4)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUSHORT, "BufferUShort", ushort, NGPU_FORMAT_R16_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUSVEC2, "BufferUSVec2", usvec2, NGPU_FORMAT_R16G16_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUSVEC3, "BufferUSVec3", usvec3, NGPU_FORMAT_R16G16B16_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERUSVEC4, "BufferUSVec4", usvec4, NGPU_FORMAT_R16G16B16A16_UNORM, NGLI_TYPE_NONE)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERFLOAT, "BufferFloat", float, NGPU_FORMAT_R32_SFLOAT, NGLI_TYPE_F32)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERVEC2, "BufferVec2", vec2, NGPU_FORMAT_R32G32_SFLOAT, NGLI_TYPE_VEC2)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERVEC3, "BufferVec3", vec3, NGPU_FORMAT_R32G32B32_SFLOAT, NGLI_TYPE_VEC3)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERVEC4, "BufferVec4", vec4, NGPU_FORMAT_R32G32B32A32_SFLOAT, NGLI_TYPE_VEC4)
DEFINE_BUFFER_CLASS(NGL_NODE_BUFFERMAT4, "BufferMat4", mat4, NGPU_FORMAT_R32G32B32A32_SFLOAT, NGLI_TYPE_MAT4)
