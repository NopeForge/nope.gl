...
static int draw_glyphs(struct distmap *s)
{
    ...
    ngli_pipeline_compat_update_buffer(s->pipeline_compat, 0, s->vert_buffer, 0, (uint32_t)s->vert_offset);
    ngli_pipeline_compat_update_buffer(s->pipeline_compat, 1, s->frag_buffer, 0, (uint32_t)s->frag_offset);
