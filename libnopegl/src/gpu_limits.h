...
#define NGLI_GPU_MAX_ATTRIBUTES_PER_BUFFER 16
#define NGLI_GPU_MAX_UNIFORM_BUFFERS_DYNAMIC 8
#define NGLI_GPU_MAX_STORAGE_BUFFERS_DYNAMIC 4
#define NGLI_GPU_MAX_DYNAMIC_OFFSETS (NGLI_GPU_MAX_UNIFORM_BUFFERS_DYNAMIC + NGLI_GPU_MAX_STORAGE_BUFFERS_DYNAMIC)
#define NGLI_GPU_MAX_VERTEX_BUFFERS 32

#define NGLI_GPU_MAX_COLOR_ATTACHMENTS 8
