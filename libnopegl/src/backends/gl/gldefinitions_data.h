...
static const struct gldefinition {
    ...
    {"glBindVertexArrayOES", offsetof(struct glfunctions, BindVertexArrayOES), 0},
    ...
    {"glDeleteVertexArraysOES", offsetof(struct glfunctions, DeleteVertexArraysOES), 0},
    ...
    {"glGenVertexArraysOES", offsetof(struct glfunctions, GenVertexArraysOES), 0},
    ...
    {"glMapBufferRange", offsetof(struct glfunctions, MapBufferRange), 0},
    ...
    {"glUnmapBuffer", offsetof(struct glfunctions, UnmapBuffer), 0},
