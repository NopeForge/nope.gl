...
static const struct {
    ...
    [NGLI_BLENDING_SRC_OVER] = {NGLI_GPU_BLEND_FACTOR_ONE,                 NGLI_GPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
    [NGLI_BLENDING_DST_OVER] = {NGLI_GPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGLI_GPU_BLEND_FACTOR_ONE},
    [NGLI_BLENDING_SRC_OUT]  = {NGLI_GPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGLI_GPU_BLEND_FACTOR_ZERO},
    [NGLI_BLENDING_DST_OUT]  = {NGLI_GPU_BLEND_FACTOR_ZERO,                NGLI_GPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
    [NGLI_BLENDING_SRC_IN]   = {NGLI_GPU_BLEND_FACTOR_DST_ALPHA,           NGLI_GPU_BLEND_FACTOR_ZERO},
    [NGLI_BLENDING_DST_IN]   = {NGLI_GPU_BLEND_FACTOR_ZERO,                NGLI_GPU_BLEND_FACTOR_SRC_ALPHA},
    [NGLI_BLENDING_SRC_ATOP] = {NGLI_GPU_BLEND_FACTOR_DST_ALPHA,           NGLI_GPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
    [NGLI_BLENDING_DST_ATOP] = {NGLI_GPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGLI_GPU_BLEND_FACTOR_SRC_ALPHA},
    [NGLI_BLENDING_XOR]      = {NGLI_GPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGLI_GPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
};
