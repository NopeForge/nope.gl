...
static const struct {
    ...
    [NGLI_BLENDING_SRC_OUT]  = {NGPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGPU_BLEND_FACTOR_ZERO},
    [NGLI_BLENDING_DST_OUT]  = {NGPU_BLEND_FACTOR_ZERO,                NGPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
    [NGLI_BLENDING_SRC_IN]   = {NGPU_BLEND_FACTOR_DST_ALPHA,           NGPU_BLEND_FACTOR_ZERO},
    [NGLI_BLENDING_DST_IN]   = {NGPU_BLEND_FACTOR_ZERO,                NGPU_BLEND_FACTOR_SRC_ALPHA},
    [NGLI_BLENDING_SRC_ATOP] = {NGPU_BLEND_FACTOR_DST_ALPHA,           NGPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
    [NGLI_BLENDING_DST_ATOP] = {NGPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGPU_BLEND_FACTOR_SRC_ALPHA},
    [NGLI_BLENDING_XOR]      = {NGPU_BLEND_FACTOR_ONE_MINUS_DST_ALPHA, NGPU_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA},
};
