...
#define NGLI_PATH_SEGMENT_FLAG_CLOSING    (1U << 1) /* the current segment is closing the sub-path */
#define NGLI_PATH_SEGMENT_FLAG_OPEN_END   (1U << 2) /* the current segment is ending a sub-path openly */
