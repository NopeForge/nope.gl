...
static const struct node_param graphicconfig_params[] = {
    ...
    {"blend",              NGLI_PARAM_TYPE_BOOL,   OFFSET(blend),              {.i64=-1},
                           .desc=NGLI_DOCSTRING("enable blending")},
    {"blend_src_factor",   NGLI_PARAM_TYPE_SELECT, OFFSET(blend_src_factor),   {.i64=-1},
                           .choices=&blend_factor_choices,
                           .desc=NGLI_DOCSTRING("blend source factor")},
    {"blend_dst_factor",   NGLI_PARAM_TYPE_SELECT, OFFSET(blend_dst_factor),   {.i64=-1},
                           .choices=&blend_factor_choices,
                           .desc=NGLI_DOCSTRING("blend destination factor")},
    {"blend_src_factor_a", NGLI_PARAM_TYPE_SELECT, OFFSET(blend_src_factor_a), {.i64=-1},
                           .choices=&blend_factor_choices,
                           .desc=NGLI_DOCSTRING("alpha blend source factor")},
    {"blend_dst_factor_a", NGLI_PARAM_TYPE_SELECT, OFFSET(blend_dst_factor_a), {.i64=-1},
                           .choices=&blend_factor_choices,
                           .desc=NGLI_DOCSTRING("alpha blend destination factor")},
    {"blend_op",           NGLI_PARAM_TYPE_SELECT, OFFSET(blend_op),           {.i64=-1},
                           .choices=&blend_op_choices,
                           .desc=NGLI_DOCSTRING("blend operation")},
    {"blend_op_a",         NGLI_PARAM_TYPE_SELECT, OFFSET(blend_op_a),         {.i64=-1},
                           .choices=&blend_op_choices,
                           .desc=NGLI_DOCSTRING("alpha blend operation")},
    {"color_write_mask",   NGLI_PARAM_TYPE_FLAGS,  OFFSET(color_write_mask),   {.i64=-1},
                           .choices=&component_choices,
                           .desc=NGLI_DOCSTRING("color write mask")},
    {"depth_test",         NGLI_PARAM_TYPE_BOOL,   OFFSET(depth_test),         {.i64=-1},
                           .desc=NGLI_DOCSTRING("enable depth testing")},
    {"depth_write_mask",   NGLI_PARAM_TYPE_BOOL,   OFFSET(depth_write_mask),   {.i64=-1},
                           .desc=NGLI_DOCSTRING("depth write mask")},
    {"depth_func",         NGLI_PARAM_TYPE_SELECT, OFFSET(depth_func),         {.i64=-1},
    ...
    {"stencil_write_mask", NGLI_PARAM_TYPE_INT,    OFFSET(stencil_write_mask), {.i64=-1},
    ...
    {"stencil_func",       NGLI_PARAM_TYPE_SELECT, OFFSET(stencil_func),       {.i64=-1},
                           ...
                           .choices=&func_choices},
    {"stencil_ref",        NGLI_PARAM_TYPE_INT,    OFFSET(stencil_ref),        {.i64=-1},
                           .desc=NGLI_DOCSTRING("stencil reference value to compare against")},
    {"stencil_read_mask",  NGLI_PARAM_TYPE_INT,    OFFSET(stencil_read_mask),  {.i64=-1},
    ...
    {"stencil_depth_fail", NGLI_PARAM_TYPE_SELECT, OFFSET(stencil_depth_fail), {.i64=-1},
                           .choices=&stencil_op_choices,
                           .desc=NGLI_DOCSTRING("operation to execute if depth test fails")},
    {"stencil_depth_pass", NGLI_PARAM_TYPE_SELECT, OFFSET(stencil_depth_pass), {.i64=-1},
                           .choices=&stencil_op_choices,
                           .desc=NGLI_DOCSTRING("operation to execute if stencil and depth test pass")},
    {"cull_mode",          NGLI_PARAM_TYPE_SELECT, OFFSET(cull_mode),          {.i64=-1},
                           .choices=&cull_mode_choices,
                           .desc=NGLI_DOCSTRING("face culling mode")},
    {"scissor_test",       NGLI_PARAM_TYPE_BOOL,   OFFSET(scissor_test),       {.i64=-1},
