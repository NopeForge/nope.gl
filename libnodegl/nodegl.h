...
#define NGL_NODE_ANIMATIONFLOAT         NGLI_FOURCC('A','n','m','1')
...
#define NGL_NODE_BUFFERUBYTE            NGLI_FOURCC('B','f','u','b')
#define NGL_NODE_BUFFERUINT             NGLI_FOURCC('B','f','u','i')
#define NGL_NODE_BUFFERUSHORT           NGLI_FOURCC('B','f','u','s')
