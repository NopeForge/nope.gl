...
static const int * const param_type_to_nodes[] = {
    ...
    [NGLI_PARAM_TYPE_F32]      = (const int[]){NGL_NODE_ANIMATEDFLOAT, NGL_NODE_EVALFLOAT, NGL_NODE_NOISEFLOAT, NGL_NODE_STREAMEDFLOAT, NGL_NODE_UNIFORMFLOAT, NGL_NODE_VELOCITYFLOAT, -1},
    ...
    [NGLI_PARAM_TYPE_MAT4]     = (const int[]){NGL_NODE_STREAMEDMAT4, NGL_NODE_UNIFORMMAT4, NGL_NODE_UNIFORMQUAT, NGL_NODE_ANIMATEDQUAT, -1},
    ...
    [NGLI_PARAM_TYPE_VEC2]     = (const int[]){NGL_NODE_ANIMATEDVEC2, NGL_NODE_EVALVEC2, NGL_NODE_NOISEVEC2, NGL_NODE_STREAMEDVEC2, NGL_NODE_UNIFORMVEC2, NGL_NODE_VELOCITYVEC2, -1},
    [NGLI_PARAM_TYPE_VEC3]     = (const int[]){NGL_NODE_ANIMATEDVEC3, NGL_NODE_EVALVEC3, NGL_NODE_NOISEVEC3, NGL_NODE_STREAMEDVEC3, NGL_NODE_UNIFORMVEC3, NGL_NODE_VELOCITYVEC3, NGL_NODE_UNIFORMCOLOR,  NGL_NODE_ANIMATEDPATH, -1},
    [NGLI_PARAM_TYPE_VEC4]     = (const int[]){NGL_NODE_ANIMATEDVEC4, NGL_NODE_EVALVEC4, NGL_NODE_NOISEVEC4, NGL_NODE_STREAMEDVEC4, NGL_NODE_UNIFORMVEC4, NGL_NODE_VELOCITYVEC4, NGL_NODE_UNIFORMCOLORA, NGL_NODE_UNIFORMQUAT, NGL_NODE_ANIMATEDQUAT, -1},
};
