...
static const int * const param_type_to_nodes[] = {
    ...
    [NGLI_PARAM_TYPE_VEC4]     = (const int[]){NGL_NODE_ANIMATEDVEC4, NGL_NODE_EVALVEC4, NGL_NODE_NOISEVEC4, NGL_NODE_STREAMEDVEC4, NGL_NODE_UNIFORMVEC4, NGL_NODE_VELOCITYVEC4, NGL_NODE_UNIFORMCOLORA, NGL_NODE_ANIMATEDQUAT, -1},
};
